...
Patch03: 0003-gnocchi-add-support-for-apache-centos-http-package.patch
Patch04: 0004-gnocchi-remove-gnocchi-upgrade-option-and-set-coordi.patch
Patch05: 0005-Revert-Helm-Toolkit-Move-sensitive-config-data-to-se.patch
Patch06: 0006-Revert-gnocchi-use-of-k8s-secret-to-store-config.patch
