...
%{__install} -m 0644 rabbitmq-server.service.example  %{buildroot}%{_datadir}/starlingx/stx.rabbitmq-server.service
...
if [ $1 -eq 1 ] ; then
        ...
        cp -f %{_datadir}/starlingx/stx.rabbitmq-server.service   %{_unitdir}/rabbitmq-server.service 
...
%{_datadir}/starlingx/stx.rabbitmq-server.service
