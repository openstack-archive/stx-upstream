...
# For more information, see horizon's customization (https://docs.openstack.org/horizon/latest/admin/customize-configure.html#horizon-customization-module-overrides)
...
OPERATION_LOG_OPTIONS = {
    'mask_fields': ['password', 'bm_password', 'bm_confirm_password',
                    'current_password', 'confirm_password', 'new_password', 'fake_password'],
